...
import { addDocumentToSession } from "../controllers/chatsession.controller.js";
...
chatSessionrouter.post("/:sessionId/upload",verifyJWT,uploadChatDocuments,addDocumentToSession);
